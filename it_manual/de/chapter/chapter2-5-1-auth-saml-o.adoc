...
```
*Hinweis:* Diese Werte finden Sie in den Metadaten Ihrer Anwendung/SAML-SP.
```
...
```
*Hinweis:*Daten Notieren/Kopieren. Diese Daten werden für die Konfiguration der Anwendung {application} benötigt. (siehe "Installation und Konfiguration")
```
