...
|Wie erfolgt sie Authentifizierung?|über die lokale Benutzer-/Passwortverwaltung (DB des Kunden)
...
|Welche externen Dokumente/Verzeichnisse können integriert werden?|{application} unterstützt:
