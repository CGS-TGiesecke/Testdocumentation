...
Die Dateien werden vom Kunden per and hochgeladen. 
...
Sind diese Daten nicht vorhanden, muss die Applikation {application} vom Kunden erst in Microsoft Entra ID unter https://kunde.sharepoint.com/sites/ registriert werden.
...
** Optional können Sie API-Berechtigungen konfigurieren (**ClientSecrets** anlegen), Zertifikate hinzufügen usw., je nach Bedarf der Anwendung.
