...
Es besteht auch die Möglichkeit die Anwendungsfälle die einem Ablauf folgen müssen, workflowbasiert anzuzeigen. Das bedeutet erst wenn Anwendungsfall 1 ausgeführt ist, steht Anwendungsfall 2, 
dessen Voraussetzung Anwendungsfall 1 ist, zur Verfügung.
