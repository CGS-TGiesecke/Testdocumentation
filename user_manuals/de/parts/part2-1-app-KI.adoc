...
Über ein Drop-Down Fenster besteht die Möglichkeit einen der diversen, meist kontextbezogenen Agenten auszuwählen, die bei der Abfrage 
eingesetzt werden sollen. Diese Agenten machen einen KI‑Einsatz im Unternehmen sicher, strukturiert und beherrschbar. 
Sie steuern gezielt, „was die KI darf und was nicht“ und bieten klare, nachvollziehbare Schnittstellen zu Daten und Systemen.
Die KI kann *nur* auf solche Daten zugreifen, wie es der Agent explizit erlaubt (z.B. nur „suchen“, aber nicht „löschen“).
Es ist also kein direkter unkontrollierter Zugriff auf Unternehmenssysteme möglich.
...
ifeval::[{arc-assist} == 1]
image::../images/arc-Abbildung-4.jpg[Navigationsbereich KI Chat  - speichern, title="Navigationsbereich AI Chat  - speichern", width=500]
endif::[]
