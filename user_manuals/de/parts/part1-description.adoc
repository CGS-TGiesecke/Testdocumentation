...
ifeval::[{cgs-assist} == 1]
image::../images/cgs-Abbildung-start.jpg[CGS Assist,title="CGS Assist", width=600]
endif::[]

ifeval::[{arc-assist} == 1]
image::../images/arc-Abbildung-start.jpg[Arc Assist,title="Arc Assist", width=600]
endif::[]
...
image::../images/Abbildung-3.jpg[Sprachwechsel und Darkmode, title="Sprachwechsel und Darkmode", width=600]
