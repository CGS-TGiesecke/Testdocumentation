...
Es kann vor dem Ausführen von Anfragen ausgewählt werden, ob der Dokumentenort (RAG) *oder* die Inhalte der Datenbank zur Wissensfindung durchsucht werden sollen. 
