...
There is also the option to display use cases that must follow a defined sequence in a workflow-based manner. This means that Use Case 2, 
which depends on Use Case 1 as a prerequisite, becomes available only after Use Case 1 has been executed.
