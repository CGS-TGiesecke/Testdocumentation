...
On this site, roles can be created and edited. When creating a new role, a system-wide unique role name must be assigned. Each role can have a description. The name and the description can be changed at any time.
