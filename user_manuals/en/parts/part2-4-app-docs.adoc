...
lazy-loading has been implemented. This allows individual embeddings (representations in which information (such as words, sentences, images, or other data ) 
is converted into mathematical vectors), to be manually reloaded using the reload icon.
