...
Before executing requests, you can select whether the document location (RAG) *or* the contents of the database should be searched to find information. 
It is not possible to search both at the same time.
