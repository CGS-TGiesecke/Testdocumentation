...
All automated AI agents are listed and managed here, provided you have the necessary permissions.
These agents are application cases defined in the administration that have been approved for automation.
