...
LLM-Modellen ausgewählt werden, welches LLM für die Anfrage genutzt werden soll. Über ein Drop-Down Fenster können 
...
zentral hinterlegt ist. Damit können unterschiedlichste Benutzer auch ohne Prompting Erfahrung sehr gute Ergebnisse erzielen. 
...
In dieser Übersicht kann für jeden Agenten Use Case festgelegt werden, ob die Aufgaben zu spezifischen Zeiten oder periodisch ausgeführt werden. 
...
haben und durchgelaufen sind. Auch die umfangreichen Details der Ergebnisse können hier eingesehen werden.
...
Auch ohne jegliches Knowhow wie ein RAG funktioniert, kann auch ein Benutzer über eine Hochlade-Funktion 
neue Dokumente ins RAG hochladen, über den Refresh Button das RAG aktualiseren oder über "Ausgewählte Embeddings löschen" 
einzelne Dokumente löschen. Damit werden einige Funktionen eines Dokumentenmangementsystems abgedeckt und Benutzer auch ohne 
