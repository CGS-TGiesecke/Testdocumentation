...
|Formularbasierte Use Cases |Ja, fertige Formulare für Kunden-Use-Cases|Nein |Nein
...
|Nutzer- & Rollenmanagement |Ja, mit kundenspezifischer Rollenlogik|Ja, aber nicht auf RAG/Kunde zugeschnitten |Beschränkt (v.a. Organisation vs. Nutzer)
